...
AbstractFlatArray* AbstractTwoDArray::convertToFlat() {
    ...
    return AbstractFlatArray;  // This creates a new FlatArray and returns its pointer
}

int** AbstractTwoDArray::getArray(){
    return __Arr;
}
int AbstractTwoDArray::getWidth(){
    return __width;
}
int AbstractTwoDArray::getHeight(){
    return __height;
}
//find
